...
export function issueSessionCookie() {
  ...
  return `${COOKIE_NAME}=${value}; Max-Age=${SESSION_SECONDS}; Path=/api/uploader-; HttpOnly; Secure; SameSite=Strict`;
}

export function clearSessionCookie() {
  return `${COOKIE_NAME}=; Max-Age=0; Path=/api/uploader-; HttpOnly; Secure; SameSite=Strict`;
}
